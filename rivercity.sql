...
CREATE TABLE `agency` (
  ...
  `agency_description` mediumtext COLLATE utf8_unicode_ci,
  ...
  `is_representative` int(1) NOT NULL,
...
-- Records of agency
-- ----------------------------
INSERT INTO `agency` VALUES ('1', 'Sai Gon House', 'mô tả nhà môi giới', 'http://localhost:8080/rivercity/resources/lienhe/images/xSeaReal.jpg.pagespeed.ic.XItLGgo77q.jpg', '0974 444 678', '1', '1');
INSERT INTO `agency` VALUES ('2', 'Huu Duyen', 'mô tả nhà môi giới', 'http://localhost:8080/rivercity/resources/lienhe/images/xhuuduyen.png.pagespeed.ic.FoP1iC_jox.png', '0909 888 039', '1', '1');
INSERT INTO `agency` VALUES ('3', 'Truong Nguyen', 'mô tả nhà môi giới', 'http://localhost:8080/rivercity/resources/lienhe/images/xtruongnguyen.png.pagespeed.ic.Qz6kQu4iT4.png', '0901 682 868', '1', '1');
INSERT INTO `agency` VALUES ('4', 'Happy Land', 'mô tả nhà môi giới', 'http://localhost:8080/rivercity/resources/lienhe/images/xhappyland-logo-FA.jpg.pagespeed.ic.nSg-yhSwL9.jpg', '0949 989 558', '1', '1');
INSERT INTO `agency` VALUES ('5', 'ThienDuc Real', 'mô tả nhà môi giới', 'http://localhost:8080/rivercity/resources/lienhe/images/xthienduc.png.pagespeed.ic._R9Qtmxn-d.png', '0903 98 2772', '1', '1');
INSERT INTO `agency` VALUES ('6', 'Phat Hung', 'mô tả nhà môi giới', 'http://localhost:8080/rivercity/resources/lienhe/images/xphathung.png.pagespeed.ic.GkGJh78Cfs.png', '0937 156 969', '1', '1');
INSERT INTO `agency` VALUES ('7', 'My Hung', 'mô tả nhà môi giới', 'http://localhost:8080/rivercity/resources/lienhe/images/xmyhung.png.pagespeed.ic.aROyIQ9_yU.png', '0911 775 888', '1', '1');
INSERT INTO `agency` VALUES ('8', 'Nguyễn Hồng Trang', 'mô tả nhà môi giới', 'http://genknews.genkcdn.vn/k:2015/1-chan-dung-nu-game-thu-khien-bao-chang-ngam-dang-nuot-cay-1421740922168/chan-dung-nu-game-thu-khien-bao-chang-ngam-dang-nuot-cay.jpg', '0919910070', '0', '1');
INSERT INTO `agency` VALUES ('9', 'Nguyễn Hồng Trang', '', 'http://genknews.genkcdn.vn/k:2015/1-chan-dung-nu-game-thu-khien-bao-chang-ngam-dang-nuot-cay-1421740922168/chan-dung-nu-game-thu-khien-bao-chang-ngam-dang-nuot-cay.jpg', '0919910070', '0', '1');
...
CREATE TABLE `broker` (
  ...
  `broker_image` varchar(255) DEFAULT NULL,
...
CREATE TABLE `buy_post` (
  ...
  `post_is_vip` int(1) DEFAULT NULL,
  PRIMARY KEY (`post_id`)
...
CREATE TABLE `news_category` (
  ...
  `category_view_count` int(11) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `news_category` VALUES ('1', 'Gói hỗ trợ 30.000 tỷ', '19');
INSERT INTO `news_category` VALUES ('2', 'Bảng giá đất năm 2016', '21');
INSERT INTO `news_category` VALUES ('3', 'Thị trường bất động sản 2016', '18');
...
CREATE TABLE `news_real` (
  ...
  `news_short_title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `news_user` int(11) DEFAULT NULL,
  `news_site` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `news_is_approve` int(1) DEFAULT NULL,
...
CREATE TABLE `project` (
  ...
  `project_position` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `project_coordinates` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `project_Infrastructure` mediumtext COLLATE utf8_unicode_ci,
  `project_design_form` mediumtext COLLATE utf8_unicode_ci,
  `project_sell` mediumtext COLLATE utf8_unicode_ci,
  `project_financial_support` mediumtext COLLATE utf8_unicode_ci,
...
-- Records of project
-- ----------------------------
INSERT INTO `project` VALUES ('1', 'Lan Phương MHBR', '0', '0', 'http://tienphatcorp.com/Content/File/Remsigns/i5a-phoi-canh-soho-premier-3.jpg', '', '', null, null, null, null, null, null);
...
-- ----------------------------
INSERT INTO `sell_post` VALUES ('sp01', 'Căn hộ Lan phương TT 30% nhận nhà và sổ, NHHT 70%, 350 triệu/70m2/2PN, thanh toán linh hoạt', '1', 'BCHCC', '0', '0', '0', '0', '80', '25', 'BGT', '- Căn hộ được thiết kế hiện đại, có ban công thoáng mát, hướng Tây Bắc, Đông Nam đón lấy nắng gió thiên nhiên, tạo cho khách hàng không gian sống rộng rãi. Nội thất đầy đủ, tiện nghi, đạt chuẩn Singapore, vật liệu an toàn với người sử dụng và thân thiện với môi trường.', '2016-08-23 22:06:26', 'http://file4.batdongsan.com.vn/resize/745x510/2016/06/28/20160628144803-e7e2.jpg', '1', '1');
INSERT INTO `sell_post` VALUES ('sp02', 'Căn hộ Lan phương TT 30% nhận nhà và sổ, asdfasdkfj laskdjfkaj sdlfjl asdfas', '2', 'BCHCC', '0', '0', '0', '0', '80', '25', 'BGT', '- Căn hộ được thiết kế hiện đại, có ban công thoáng mát, hướng Tây Bắc, Đông Nam đón lấy nắng gió thiên nhiên, tạo cho khách hàng không gian sống rộng rãi. Nội thất đầy đủ, tiện nghi, đạt chuẩn Singapore, vật liệu an toàn với người sử dụng và thân thiện với môi trường', '2016-08-24 22:06:38', 'http://file4.batdongsan.com.vn/resize/745x510/2016/06/28/20160628144803-e7e2.jpg', '1', '1');

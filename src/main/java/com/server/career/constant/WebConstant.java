...
public class WebConstant {
	 ...
	 * Time
	 */
	public static final String COMMON_TIME_FORMAT = "dd-MM-yyyy";
	public static final String COMMON_TIME_FORMAT_SQL = "yyyy-MM-dd hh:mm:ss";
	public static final String COMMON_TIME_PICKER_FORMAT = "yyyy-MM-dd";
	/*
	 * Gender
	 * 
	 * 0: Nam

			...
			<div
				...
				<div class="item-wrapper"
					...
					<c:forEach var="sInformationSpecial" items="${informationSpecial}"
						varStatus="loop">
						<div class="item-container" data-hash="${sInformationSpecial.inforDataHash}"
							data-href="${sInformationSpecial.inforUrl}"
							data-name="${sInformationSpecial.inforDataName}" data-title="RIVER CITY - ${sInformationSpecial.inforName}"

		...
		<div id="TopBanner">
			...
			<div class="container-default">
				<div id="ctl26_BodyContainer">
					<div class="adPosition" positionCode="BANNER_POSITION_TOP" style=""
						hasShare="True" hasNotShare="False"></div>
				</div>
...
.max155 {
	max-width: 90px !important;
			...
			<div id="divUserStt">
				<div id="UserControl1_divLogout">
					<div class="header-middle-righ-link">
						<a href="trang-dang-nhap.html" rel="nofollow">Đăng nhập</a>
					</div>
					<div class="header-middle-righ-icon">
						<img
				...
				<div id="UserControl1_divRegister">
					<div class="header-middle-righ-link max155" id="kct_username">
						<a href="dang-ky-nguoi-dung.html" title="Đăng ký" rel="nofollow">Đăng
							ký </a>
					</div>
			...
			<div id="UserControl1_divPostFAQ">
				<div class="header-middle-righ-link">
					<a href="dang-tin-hoi-dap.html"><span class="HeaderText">Hỏi
							đáp</span></a>
				</div>
				<div class="header-middle-righ-icon">
					<img
			...
			<div>
				<div id="UserControl1_divPostProduct"
					class="header-middle-righ-link">
					<a href="dang-tin-rao-vat-ban-nha-dat.html"
						id="UserControl1_linkPostProduct"><span>Đăng tin rao</span></a>
				</div>
				<div class="header-middle-righ-icon">
					<img
			...
			<div id="UserControl1_div1">
				<div class="header-middle-righ-link">
					<a href="gioi-thieu-phien-ban-mobile.html" rel="nofollow"><span
				...
				<div id="UserControl1_bxhicon">
					...
					<div class="header-middle-righ-link" style="margin-right: 5px;">
						<a href="http://banxehoi.com/" target="_blank"
							title="banxehoi.com"><span class="HeaderText">Banxehoi.com</span></a>
					</div>

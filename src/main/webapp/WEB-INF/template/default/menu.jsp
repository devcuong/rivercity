...
<div class="top">
		<div class="navigation show">
			<div class="nav">
				<ul>
					<li class="current"><a class="link-home"
						href="http://rivercity.vn/" data-name="home-page">Home</a></li>
					<li><a class="play-video" href="javascript:void(0);"
						data-href="view-video.html?id=7">Video</a></li>
			...
			<div class="lang">
				<form id="change_lang" enctype="multipart/form-data" method="post"
					...
					<input type="hidden" value="" name="language_code"> <input
						...
						value="http://rivercity.vn/" name="redirect">
				</form>
			</div>
			<!--LANGUAGE-->
		</div>

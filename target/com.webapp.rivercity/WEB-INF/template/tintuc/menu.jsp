	...
	<div class="navigation">
		<div class="nav">
			<ul>
				...
				<li><a class="link-load" href="../thong-tin-can-ho.html"
				...
				<li class="current"><a class="link-load" href="../tin-tuc.html"
		...
		<div class="lang">
			<form id="change_lang" enctype="multipart/form-data" method="post"
				...
				<input type="hidden" value="" name="language_code" /> <input
					...
					value="http://rivercity.vn/tin-tuc/200-trieu-usd-chay-vao-dia-oc.html"
					name="redirect" />
			</form>
		</div>
		<!--LANGUAGE-->
